...
public class ViewPagos extends javax.swing.JFrame {
    ...
    public ViewPagos() {
        ...
        new CambiaPanel(pnlPrincipal, new paneles.pnlObra());
    }
    ...
    private void initComponents() {
        ...
        cuatro.setText("Pagos Independientes");
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(ViewPagos.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
